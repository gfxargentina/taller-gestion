      ...
      <div className="flex max-w-6xl mx-auto items-start justify-center p-5">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-2" >
          ...
          <div className="flex flex-col md:col-span-2 ">
            ...
            <div className="bg-white shadow-lg rounded-md p-2 h-24 w-auto border border-blue-500"> {aparato.falla} </div>
          </div>
          <div className="flex flex-col md:col-span-2 ">
            <label className="font-bold">Observaciones</label>
            <div className="bg-white shadow-lg rounded-md p-2 h-24 w-auto border border-blue-500"> {aparato.observaciones} </div>
          </div>
          <div className="flex flex-col md:col-span-2 ">
            <label className="col-auto font-bold">Presupuesto</label>            
            <div className="bg-white shadow-lg rounded-md p-2 h-24 w-auto border border-blue-500" > {aparato.presupuesto}  </div>
          </div>
